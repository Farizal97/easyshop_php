...
<head>
    <meta charset="UTF-8">
    <title>BekasiGregetSolution | Login</title>
            ...
            $akun_cocok = $ambil->num_rows;
             ...
             if($akun_cocok == 1) {
                 ...
                 if(isset($_SESSION['keranjang']) OR !empty($_SESSION['keranjang'])) {
                   ...
                   echo "<div class='alert alert-danger text-center'>Login Gagal,Silahkan Perika Akun Anda</div>";
